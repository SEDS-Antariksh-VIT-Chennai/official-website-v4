                    ...
                    {existingGallery.map((url, i) => (
                      <div key={`existing-${i}`} className="relative aspect-square rounded overflow-hidden border border-white/20 group pointer-events-auto">
                        ...
                        <button 
                          ...
                          className="absolute top-1 right-1 bg-black/70 text-white rounded-full w-6 h-6 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity z-30 hover:bg-red-500"
                        >
                          &times;
                        </button>
                      </div>
