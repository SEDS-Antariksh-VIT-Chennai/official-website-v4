  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-4">
        ...
        <Link href="/admin/events/new" className="flex items-center gap-2 bg-white text-black px-6 py-3 font-bold uppercase tracking-widest text-xs rounded-none hover:bg-gray-200 transition-colors">
              ...
              <tr key={event.id} className="hover:bg-white/[0.02] transition-colors">
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <Link href={`/admin/events/${event.id}/edit`} className="p-2 border border-white/5 hover:bg-white/10 hover:border-white/30 rounded-none transition-colors text-white/50 hover:text-white" title="Edit">
