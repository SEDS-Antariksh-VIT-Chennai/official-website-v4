...
import { createProject } from "@/src/actions/admin";
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8 border-b border-white/10 pb-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white mb-1">Create Project</h1>
          <p className="text-white/50 text-sm">Fill in the details below to add a new project.</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                placeholder="e.g. Project Antariksh" 
          ...
          <div className="flex flex-col gap-2">
            ...
            <input 
              ...
              placeholder="e.g. Rocket, Wrench, Code" 
              className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 focus:outline-none focus:bg-white/10 focus:border-white/50 transition-all"
            />
          </div>
